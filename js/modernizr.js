...
!function(e,n,t){
    ...
    function o(){
            ...
            if(x.hasOwnProperty(c))
        {
            ...
            for(o=r(n.fn,"function")?n.fn():n.fn,a=0;a<e.length;a++)s=e[a],i=s.split("."),
    ...
    function a(e){
        ...
        if(b&&(n=n.baseVal),Modernizr._config.enableJSClass){
            ...
            n=n.replace(r,"$1"+t+"js$2")}Modernizr._config.enableClasses&&(n+=" "+t+e.join(" "+t),
        b?w.className.baseVal=n:w.className=n)
    }
    function s(){
        return"function"!=typeof n.createElement?n.createElement(arguments[0]):b?n.createElementNS.call(n,"http://www.w3.org/2000/svg",
        arguments[0]):n.createElement.apply(n,arguments)
    }
    function i(e){
        return e.replace(/([a-z])-([a-z])/g,function(e,n,t){return n+t.toUpperCase()
        }
                ).replace(/^-/,"")
    }
    function c(){
    ...
    function l(e,t,r,o){var a,i,l,d,f="modernizr",u=s("div"),p=c();
        if(parseInt(r,10))for(;r--;)l=s("div"),l.id=o?o[r]:f+(r+1),u.appendChild(l);
        return a=s("style"),a.type="text/css",a.id="s"+f,(p.fake?p:u).appendChild(a),p.appendChild(u),
                a.styleSheet?a.styleSheet.cssText=e:a.appendChild(n.createTextNode(e)),
                u.id=f,p.fake&&(p.style.background="",p.style.overflow="hidden",
        d=w.style.overflow,w.style.overflow="hidden",w.appendChild(p)),i=t(u,e),
                p.fake?(p.parentNode.removeChild(p),w.style.overflow=d,w.offsetHeight):u.parentNode.removeChild(u),!!i
    }
    function d(e,n){
        return!!~(""+e).indexOf(n)
    }
    ...
    function u(e,n,t){
        var o;
        for(var a in e)if(e[a]in n)return t===!1?e[a]:(o=n[e[a]],r(o,"function")?f(o,t||n):o);return!1
    }function p(e){
    ...
    function m(n,r){
        ...
        if("CSS"in e&&"supports"in e.CSS){
            ...
            return!1}if("CSSSupportsRule"in e){for(var a=[];o--;)a.push("("+p(n[o])+":"+r+")");
    ...
    function v(e,n,o,a){
        ...
        for(p=e.length,u=0;
        p>u;u++)if(v=e[u],g=j.style[v],d(v,"-")&&(v=i(v)),j.style[v]!==t){if(a||r(o,"undefined"))return c(),
                    "pfx"==n?v:!0;try{j.style[v]=o}catch(h){
                    }
    ...
    var h=[],x=[],T={_version:"3.3.1",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(e,n){
        ...
        },addTest:function(e,n,t){x.push({
                name:e,fn:n,options:t
            })
        },addAsyncTest:function(e){x.push({
                name:null,fn:e})
        }
    }
    ,Modernizr=function(){
    ...
    Modernizr.addTest("audio",function(){
        var e=s("audio"),n=!1;try{
            ...
            n.m4a=(e.canPlayType("audio/x-m4a;")||e.canPlayType("audio/aac;")).replace(/^no$/,""))}catch(t){}return n}),
            ...
            T._prefixes=C,Modernizr.addTest("csscalc",function(){
                ...
                return t.style.cssText=e+C.join(n+e),!!t.style.length}),Modernizr.addTest("cssgradients",function(){
                for(var e,n="background-image:",t="gradient(linear,left top,right bottom,from(#9f9),to(white));",r="",o=0,a=C.length-1;
                a>o;o++)e=0===o?"to ":"",r+=n+C[o]+"linear-gradient("+e+"left top, #9f9, white);";
            ...
            Modernizr.addTest("touchevents",function(){
                var t;if("ontouchstart"in e||e.DocumentTouch&&n instanceof DocumentTouch)t=!0;
                else{
            ...
            var k=function(n){
                ...
                s++){
                    ...
                    if(c in a)return"@-"+i.toLowerCase()+"-"+n}return!1};
            T.atRule=k;
            ...
            Modernizr._q.unshift(function(){
                delete j.style
                    ...
                    Modernizr.addTest("video",function(){
                        var e=s("video"),n=!1;
                        try{(n=!!e.canPlayType)&&(n=new Boolean(n),
                        ...
                        return n
                            ...
                            T.testAllProps=g,
                            T.testAllProps=y,
                            Modernizr.addTest("cssanimations",
                    y("animationName","a",!0)),
                                ...
                                !!e.style.length&&(n.documentMode===t||n.documentMode>9)
                                    ...
                                    function(){
                                        ...
                                        if(e&&(!n||"webkitPerspective"in w.style)){
                                            ...
                                            ,_(r+t,function(n){e=7===n.offsetWidth&&18===n.offsetHeight})}return e}),
                                    ...
                                    Modernizr.addTest("backgroundblendmode",A("backgroundBlendMode","text")),
                                            o(),a(h),delete T.addTest,delete T.addAsyncTest;
